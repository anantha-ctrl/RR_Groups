...
export const NAV_ITEMS: NavItem[] = [
  ...
  { id: 'chit-groups', label: 'Chit Groups', icon: Group, roles: ['admin', 'agent'], group: 'Manage' },
  ...
  { id: 'my-chits', label: 'My Chits', icon: Group, roles: ['customer'], group: 'My Account' },
  { id: 'field-map', label: 'Field Map', icon: Map, roles: ['admin'], group: 'Insights' },
